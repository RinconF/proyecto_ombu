...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function searchProducts() {
        ...
        cards.forEach(card => {
            ...
            const title = card.dataset.title || 
                          card.querySelector('.main-card span').textContent;
            
            // Obtener la descripción del producto
            const description = card.querySelector('.main-card p').textContent;
    ...
    searchInput.addEventListener('keyup', function(event) {
        ...
        // Comment out the line below if you don't want real-time search
        searchProducts();
    });
    
    // Opcional: Restablecer la búsqueda cuando se borra el campo
